class OrderForm
  ...
  attr_accessor :user_id, :item_id, :postcode, :shipping_area, :city, :block, :building, :phone_number, :token
  ...
  def save
    ...
    Payment.create(order_id: order.id, postcode: postcode, shipping_area: shipping_area, city: city, block: block, building: building, phone_number: phone_number)
  end
end
